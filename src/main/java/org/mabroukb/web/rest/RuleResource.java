...
/**
 * REST controller for managing {@link org.mabroukb.domain.Rule}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class RuleResource {
     ...
     */
    @GetMapping("/rules")
    public ResponseEntity<List<Rule>> getAllRules(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
