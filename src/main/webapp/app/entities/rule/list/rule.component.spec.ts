...
describe('Rule Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'rule', component: RuleComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to ruleService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getRuleIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getRuleIdentifier).toHaveBeenCalledWith(entity);
